...
{
    & git clone --mirror https://github.com/h1laryz/hl2sdk hl2sdk-proxy-repo 2>&1 | Write-Host
}
else
{
...
$SDKS | ForEach-Object {
    Get-Repository -Name "hl2sdk-$_" -Branch $_ -Repo "hl2sdk-proxy-repo" "https://github.com/h1laryz/hl2sdk.git"
}
